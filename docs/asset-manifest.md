...
| `public/images/guides/movein-day.svg` | 640 × 360 px (16:9) | DormReady Project | Handcrafted SVG Code (Move-in day execution timeline) | Copyright © 2026 DormReady. All rights reserved. | Approved for DormReady guides, checklists, and editorial cards. |
| `public/images/guides/community-bathroom.svg` | 640 × 360 px (16:9) | DormReady Project | Handcrafted SVG Code (Community bathroom essentials) | Copyright © 2026 DormReady. All rights reserved. | Approved for DormReady guides, checklists, and editorial cards. |
| `public/images/guides/dorm-storage.svg` | 640 × 360 px (16:9) | DormReady Project | Handcrafted SVG Code (Dorm storage measurement planner) | Copyright © 2026 DormReady. All rights reserved. | Approved for DormReady guides, checklists, and editorial cards. |
| `public/images/diagrams/movein-timeline.svg` | 960 × 400 px | DormReady Project | Handcrafted SVG Code (Move-in day 4-phase flowchart) | Copyright © 2026 DormReady. All rights reserved. | Approved for DormReady move-in guides and printable aids. |
| `public/images/diagrams/bathroom-routine.svg` | 960 × 400 px | DormReady Project | Handcrafted SVG Code (Community bathroom dry/wet transit workflow) | Copyright © 2026 DormReady. All rights reserved. | Approved for DormReady bathroom guides and printable aids. |
| `public/images/diagrams/storage-measurement.svg` | 960 × 400 px | DormReady Project | Handcrafted SVG Code (4 essential dorm measurement zones) | Copyright © 2026 DormReady. All rights reserved. | Approved for DormReady storage guides and printable aids. |
